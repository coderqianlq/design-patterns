...
public class BridgePatternDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        com.qianlq.bridge.object.Shape circle = (com.qianlq.bridge.object.Shape) constructor.newInstance((ColorAPI) XMLUtil.getObject("bridge/src/main/java/com/qianlq/bridge/config/config.xml", "color"));
        circle.draw();
