...
public class BridgePatternDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        com.coderqian.bridge.object.Shape circle = (com.coderqian.bridge.object.Shape) constructor.newInstance((ColorAPI) XMLUtil.getObejct("src/cn/qianlq/bridge/config/config.xml", "color"));
        circle.draw();
